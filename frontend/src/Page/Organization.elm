                            ...
                            [ div [ class "card-content" ]
                                [ div [ class "media" ]
                                    ...
                                    , div [ class "media-content" ]
                                        [ p [ class "is-size-4" ] [ text "Humane Society" ]
                                        , p [ class "is-size-6" ] [ text "#KYHumaneSociety" ]
                                        , p [ class "is-size-6 has-text-grey" ] [ text "43 Employees" ]
                                        , p [ class "is-size-6 has-text-grey" ] [ text "EIN: 123456789" ]
                                        ]
                                    ]
                                ]
                            ]
